  ...
  return (
    <>
      <div className="flex flex-col space-y-3 py-8 m-auto min-w-full">
        ...
        <div className="flex flex-col-reverse lg:flex-row lg:space-x-6  lg:justify-between space-y-3 p-4 rounded-lg bg-white drop-shadow-lg">
          <Factor />
          <div className="flex flex-col lg:grid lg:w-full space-y-3">
