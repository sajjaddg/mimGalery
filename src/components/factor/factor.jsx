...
const Factor = () => {
  const { pTala, maliat, ezafi, wTala, profit, ojrat } =
    useContext(FactorCnotext);
  ...
  return (
    <div className="py-3 lg:grid lg:w-full lg:content-center">
      <div className="flex flex-col lg:space-y-6 lg:justify-center lg:h-fit lg:py-8 space-y-4 p-4 bg-[#243B55] rounded-lg">
        <FactorItem
